    ...
    for year in range(2000, 2018):
        for day in enumerate(days):
            for nn in range(25, 27):
                if day[1] < 10:
                    strs = (
                        "unpack_sds_bits MOD13Q1.A%d00%d.h%dv05.006.hdf -sds=\"250m 16 days VI Quality\" -bit=0-3 "
                ...
                if 10 <= day[1] < 100:
                    strs = (
                        "unpack_sds_bits MOD13Q1.A%d0%d.h%dv05.006.hdf -sds=\"250m 16 days VI Quality\" -bit=0-3 "
                ...
                if day[1] >= 100:
                    strs = (
                        "unpack_sds_bits MOD13Q1.A%d%d.h%dv05.006.hdf -sds=\"250m 16 days VI Quality\" -bit=0-3 "
